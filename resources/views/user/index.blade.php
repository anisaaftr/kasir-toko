                ...
                <tbody>
                        ...
                        @if (request()->has('search'))
                            @if ($users->isEmpty())
                                @if (is_numeric(request()->search))
                                    Nama user "{{ request()->search }}" yang dicari tidak ditemukan.
                                @else
                                    username "{{ request()->search }}" yang dicari tidak ditemukan.
                                @endif
                                @else
                    ...
                    <tr>
                        <td colspan="5" class="text-center">
                            @if(request()->has('search'))
                                Nama / Username "{{ request()->search }}" yang dicari tidak ada.
                            @endif
                        </td>
                    </tr>   
                    {{-- <tr> --}}
                        {{-- <td colspan="5" class="text-center">Nama / Username yang dicari Tidak ada.</td>
                    </tr> --}} 
                    @endforelse
                </tbody>
            </table>
